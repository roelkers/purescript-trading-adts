...
let additions =
      { 
        dotenv = 
        {
        dependencies = [ "prelude", "effect", "run", "sunde", "parsing" ]
        , repo = "https://github.com/nsaunders/purescript-dotenv"  
        , version = "master"
        },
        react-basic =
        ...
        simple-ajax = 
        {
         dependencies = [ "prelude", "effect", "record", "variant", "simple-json" ]
        , repo = "https://github.com/dariooddenino/purescript-simple-ajax.git"
        , version = "master"
        },
        simple-json = 
        {
         dependencies = [ "prelude", "effect", "record", "variant" ]
